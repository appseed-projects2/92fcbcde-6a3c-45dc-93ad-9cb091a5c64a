...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-01 11:42`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/92fcbcde-6a3c-45dc-93ad-9cb091a5c64a.git
$ cd 92fcbcde-6a3c-45dc-93ad-9cb091a5c64a
```
